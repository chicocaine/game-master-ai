...
- Attack resolution: hit check (`d20 + modifiers` vs AC, or save-vs-DC where defined), then damage, then state events (`ATTACK_HIT`/`ATTACK_MISSED`, `DAMAGE_APPLIED`, `HP_UPDATED`, `DEATH`).
